...
/sbin/busybox echo 5.00.4 > /customkernel/property/customkernel.cwm.touch.build
/sbin/busybox echo true > /customkernel/property/customkernel.base.PhilZ-cwm6
/sbin/busybox echo 5.00.4 > /customkernel/property/customkernel.base.version
/sbin/busybox echo XWLSS-OXX > /customkernel/property/customkernel.firmware.name
